...
{/*  */}
 <footer className="py-10 mt-[1300px] sm:mt-80 lg:mt-[1000px] lg:w-[1920px] flex flex-col space-y-10 justify-center bg-gradient-to-r from-gray-200 via-[#FFBD59] to-gray-200">
