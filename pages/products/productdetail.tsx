    ...
    <div className={styles.bodyProducts}>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
              ...
              <h2 className="font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 text-white mt-4">
                Wooden Stool
              </h2>
              ...
              <div className=" flex flex-row justify-between  mt-5">
                        ...
                        <p className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 font-normal text-base leading-4 text-white hover:underline hover:text-white duration-100 cursor-pointer !important">22 reviews</p>
                    </div>

                    <p className="font-normal text-base leading-6 text-white mt-7">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using. Lorem Ipsum is that it has a more-or-less normal distribution of letters.</p>
                    <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-white mt-6 ">$ 790.89</p>
                    ...
                    <div className="flex flex-row justify-between">
                        ...
                        <p className="font-medium text-base leading-4 text-white">Dimensions</p>
                            <svg onClick={() => setRotate(!rotate)} id="rotateSVG" className={"focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white-800 cursor-pointer transform " + (rotate ? "rotate-180" : "rotate-0")} width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button className="focus:outline-none focus:ring-2 hover:bg-black focus:ring-offset-2 focus:ring-white-800 font-medium text-base leading-4 text-white bg-gray-800 w-full py-5 lg:mt-12 mt-6" >Add to Cart</button>
            </div>
            </div>
            ...
            <div className="w-full lg:w-6/12 flex flex-col lg:gap-8 sm:gap-6 gap-4">
              ...
              <Slider {...carouselSettings}>
                <div>
                  <img
                    src="https://www.motolite.com/cdn/shop/products/Gold1_750x.jpg?v=1663294903"
