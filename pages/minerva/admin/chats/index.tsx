...
const Chats: FC = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const res = await fetch(`http://localhost:3001/t/mychats/${userid}
            `, {
                method: "GET",
                cache: "force-cache",
            })
    ...
    return (
        <div>
            ...
            <div className={styles.titleHead}>
                <div className={styles.icon}><TbMessage size={50} /></div>
                Chats
            </div>
            <div className={styles.chatContainer}>
                <div className="px-8 py-8 container mx-auto" >
                        ...
                        <div className="flex border border-grey rounded shadow-lg h-full">
                            ...
                            <div className="w-1/3 border flex flex-col">
                                ...
                                <div className="bg-grey-lighter flex-1 overflow-auto">
                                    ...
                                    <div className="bg-white px-3 flex items-center hover:bg-grey-lighter cursor-pointer">
                                        <div>
                                            <img className="h-12 w-12 rounded-full"
                                                src="https://media-cldnry.s-nbcnews.com/image/upload/rockcms/2023-02/harrison-ford-mc-230203-02-70c6d2.jpg" />
                                        </div>
                                        <div className="ml-4 flex-1 border-b border-grey-lighter py-4">
                                            <div className="flex items-bottom justify-between">
                                                <p className="text-grey-darkest">
                            ...
                            <div className="w-2/3 border flex flex-col">
                                ...
                                <div className="flex-1 overflow-auto " >
                                    <div className="py-2 px-3 bg-[#ffbd59]">
