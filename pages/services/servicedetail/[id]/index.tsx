...
const ServiceDetails: FC = () => {
  ...
  return (
<>
<div className="max-w-screen-xl ml-8 lg:ml-80 mx-auto px-6 md:px-8 lg:px-12 pt-32 lg:pt-40 pb-6 lg:pb-12">
    <div className="bg-yellow-100 py-8 lg:py-12 px-6 relative text-center">
